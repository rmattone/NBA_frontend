...
import SidebarComponent from '@/components/modules/social-app/partials/SidebarComponent.vue'
...
export default {
  components: { HeaderComponent, SubHeader, SidebarComponent, MainContentComponent, FooterComponent, SettingOffcanvas, LoaderComponent },
  setup() {
    ...
    return { isBanner, bannerStyle, isLoader }
  }
}
</script>
