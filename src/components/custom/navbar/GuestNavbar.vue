  ...
  <nav :class="`nav navbar navbar-expand-xl navbar-light iq-navbar ${headerNavbar} ${navbarHide.join('')}`">
    <div class="container-fluid navbar-inner">
      ...
      <div class="d-none d-xl-block ms-auto">
        <ul class="navbar-nav">
          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'default.dashboard' }"> Cemitério </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'default.contato' }"> Contato </router-link>
          </li>
        </ul>
      </div>
      <div class="d-flex align-items-center">
        <button id="navbar-toggle" class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
      ...
      <div class="offcanvas offcanvas-end d-xl-none d-md-block" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav">
            <li class="nav-item">
              <router-link class="nav-link" :to="{ name: 'default.dashboard' }" @click="close"> Cemitério </router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" :to="{ name: 'default.contato' }" @click="close"> Contato </router-link>
            </li>
          </ul>
        </div>
      </div>
