<template>
  <div class="border-bottom">
    <div class="d-flex flex-column align-content-between justify-items-center mb-3">
      <div class="d-flex justify-content-between mb-2">
        ...
        <div class="d-flex justify-content-end">
          <button class="btn btn-soft-primary btn-icon rounded-pill" data-bs-toggle="offcanvas" data-bs-target="#share-btn" aria-controls="share-btn">
      ...
      <div class="d-flex align-items-center w-100">
        <icon-component type="solid" icon-name="star" style="color: #ffd329"></icon-component>
        <icon-component type="solid" icon-name="star" style="color: #ffd329"></icon-component>
        <icon-component type="solid" icon-name="star" style="color: #ffd329"></icon-component>
        <icon-component type="solid" icon-name="star" style="color: #ffd329"></icon-component>
        <icon-component type="solid" icon-name="star" style="color: #ffd329"></icon-component>
    ...
    <div class="d-flex my-4">
      ...
      <h4 class="text-primary mb-0 ms-2">${{ amount }}</h4>
    </div>
  </div>
  <div class="border-bottom">
  ...
  <div class="d-flex flex-column py-4">
    <div class="d-flex align-items-center mb-3">
      ...
      <span class="text-primary ms-2">Friday, March 04</span>
    </div>
    <div class="d-flex align-items-center mb-3">
  ...
  <div>
    ...
    <div class="d-flex py-4 flex-wrap gap-4">
      <router-link :to="{ name: 'e-commerce.order-process' }" class="btn btn-warning d-flex align-items-center gap-2">
        <span class="btn-inner d-flex">
          <icon-component type="dual-tone" icon-name="bag" :size="20"></icon-component>
        </span>
        Buy Now
      </router-link>
      <button class="btn btn-primary d-flex align-items-center cart-btn gap-2">
        <span class="btn-inner d-flex">
          <icon-component type="dual-tone" icon-name="cart" :size="20"></icon-component>
        </span>
        Add to cart
      </button>
      <a href="./wishlist" class="btn btn-info d-flex align-items-center gap-2">
        <span class="btn-inner d-flex">
          <icon-component type="dual-tone" icon-name="heart" :size="20"></icon-component>
        </span>
        Wishlist
      </a>
    </div>
