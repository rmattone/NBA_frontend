    ...
    <b-card class="mb-0">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex justify-content-between">
          <div class="email-remove submit me-2 text-primary" @click="hideMail">
          ...
          <div class="me-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" class="mx-2" viewBox="0 0 24 24" fill="none" v-if="stars == 'false'">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" class="mx-2" viewBox="0 0 20 20" fill="none" v-else>
      ...
      <div class="d-flex justify-content-start mt-4">
        <div>
          <b-button type="button" variant="soft-secondary btn-icon rounded-circle avatar-50 d-flex align-items-center justify-content-center">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" fill="none">
        ...
        <div class="ms-2">
          <span
            >{{ senderName }}<code class="m-0 iq-word-wrap"> &#x3C;{{ senderName }}.123@gmail.com&#x3E;&#x3C;/{{ senderName }}.123&#x3E;</code></span
          ><br />
          <div class="dropdown">
            ...
            <b-table class="dropdown-menu p-3" :aria-labelledby="`dropdownMenuLink-${id}`">
              <tr>
                <th>from:</th>
      ...
      <b-row>
        <b-col sm="12" md="6" lg="6" xl="3" class="mb-4">
          <img class="img-fluid w-100 rounded-1" src="@/assets/modules/mail/images/01.png" alt="email-img" loading="lazy" />
        </b-col>
        <b-col sm="12" md="6" lg="6" xl="3" class="mb-4">
          <img class="img-fluid w-100 rounded-1" src="@/assets/modules/mail/images/02.png" alt="email-img" loading="lazy" />
        </b-col>
        <b-col sm="12" md="6" lg="6" xl="3" class="mb-4">
          <img class="img-fluid w-100 rounded-1" src="@/assets/modules/mail/images/03.png" alt="email-img" loading="lazy" />
        </b-col>
        <b-col sm="12" md="6" lg="6" xl="3">
          <img class="img-fluid w-100 rounded-1" src="@/assets/modules/mail/images/01.png" alt="email-img" loading="lazy" />
        </b-col>
      ...
      <div class="mt-3 mt-sm-0">
        <b-button type="button" variant="primary btn-md me-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <b-button type="button" variant="primary btn-md">
...
export default {
  ...
  props: {
    ...
    showcompose: { type: Boolean, default: false }
  },
  setup(props, context) {
    const hideMail = () => {
      context.emit('hide', true)
    }
    return {
      hideMail
    }
