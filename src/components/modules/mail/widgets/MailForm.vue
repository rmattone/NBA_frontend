<template>
  <b-card class="mb-0">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="d-flex align-items-center gap-3">
        ...
        <h5 class="text-primary card-title mb-0">
          {{ $t('mail.sidebar.compose-message') }}
        </h5>
      </div>
      <div v-if="closeBtn">
    ...
    <b-form class="email-form">
      <b-row>
        <b-col sm="2">
          <label for="textarea-small">To:</label>
        </b-col>
        <b-col sm="10">
          <!-- <Multiselect className="form-control" v-model="multivalue" mode="tags" :close-on-select="false" :options="options" /> -->
        </b-col>
      </b-row>
      <b-row class="mt-3">
        <b-col sm="2">
          <label for="textarea-small">Cc:</label>
        </b-col>
        <b-col sm="10">
          <!-- <Multiselect className="form-control" v-model="multivalue" mode="tags" :close-on-select="false" :options="options" /> -->
        </b-col>
      ...
      <b-row class="mt-3">
        ...
        <b-col sm="10">
          <b-form-input type="text" id="subject" class="form-control" />
        </b-col>
      </b-row>
      <b-row class="mt-3">
        <b-col sm="2">
        ...
        <b-col sm="10">
          <b-form-textarea class="form-control" rows="5" placeholder="Next, use our Get Started docs to setup Tiny!"></b-form-textarea>
        </b-col>
      </b-row>
      <div class="d-flex flex-wrap align-items-center justify-content-between mb-0 mt-3">
...
<script>
// import Multiselect from '@/components/custom/pro/multi-select/multi-select.vue'
export default {
  name: 'MailForm',
  components: {
    // Multiselect
  ...
  data() {
    return {
      ...
      // multivalue: ['choise'],
      // multivalue1: ['choise1'],
      // options: ['Barb Dwyer', 'Brock Lee', 'Rick OShea', 'Cliff Hanger'],
      // multioptions: ['Barb Dwyer', 'Brock Lee', 'Rick OShea', 'Cliff Hanger']
    }
  }
}
</script>
