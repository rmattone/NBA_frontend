  ...
  <b-card>
    <div class="d-flex justify-content-between align-items-center flex-wrap">
      <ul class="nav nav-pills mb-0" data-toggle="slider-tab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#pills-about-tab" data-bs-toggle="tab" data-bs-target="#about" aria-selected="false" role="tab">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#pills-friends-tab" data-bs-toggle="tab" data-bs-target="#friends" aria-selected="false" role="tab">Friends <span class="badge bg-success d-inline-block py-1 ms-2">100</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#pills-photos-tab" data-bs-toggle="tab" data-bs-target="#photos" aria-selected="false" role="tab">Photos</a>
        </li>
      </ul>
      <div class="d-flex flex-wrap flex-sm-nowrap gap-3">
        <div class="d-flex justify-content-between align-items-center gap-3 mb-3 mb-sm-0">
          <b-button variant="icon btn-primary" size="sm" pill>
          ...
          <span>
            <img class="img-fluid rounded-circle avatar-30" src="@/assets/modules/social-app/images/avatar/01.png" alt="user-img" loading="lazy" />
          </span>
        </div>
        <div class="nav">
          <b-form class="form-group input-group mb-0 search-input w-100">
