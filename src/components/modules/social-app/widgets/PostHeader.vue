  ...
  <b-card-header class="d-flex justify-content-between">
    <div class="header-title">
      <div class="d-flex justify-content-center flex-wrap">
        <div class="me-3">
          <img class="img-fluid rounded-circle p-1 border border-2 border-primary border-dotted avatar-50" :src="require(`@/assets/modules/social-app/images/${userProfile}`)" alt="profile-img" />
        </div>
