<template>
  <div class="d-flex flex-wrap justify-content-between align-items-center">
    <div class="d-flex align-items-center">
      ...
      <div class="total-comment-block me-3">
        <div class="dropdown">
          <a href="javascript:void(0);" id="commentdropdown" class="text-body d-flex align-items-center gap-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
