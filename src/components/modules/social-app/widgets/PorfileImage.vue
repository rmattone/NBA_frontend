<template>
  <div class="user-images position-relative overflow-hidden">
    <a>
      <img :src="`${profileimagesimg}`" class="img-fluid rounded" alt="Responsive image" loading="lazy" />
    </a>
    <div class="image-hover-data">
      <div class="product-elements-icon">
        <ul class="d-flex align-items-center m-0 p-0 list-inline">
          <li>
            <a href="#" class="text-white d-flex justify-content-center align-items-center">
              {{ profileimageslike }}
              <svg width="20" class="ms-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a href="#" class="ps-3 text-white d-flex justify-content-center align-items-center">
              {{ profileimagescomment }}
              <svg width="20" class="ms-1" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <a v-b-tooltip.hover href="#" class="image-edit-btn btn bg-white btn-sm btn-icon position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit or Remove">
...
export default {
  ...
  props: {
    type: String,
    fslightboximg: { default: '' },
    profileimagesimg: { default: '' },
    profileimageslike: { default: '' },
    profileimagescomment: { default: '' },
    profileimagesshare: { default: '' }
  }
}
</script>
