<template>
  <b-card no-body class="iq-file-manager">
    <b-card-body class="card-thumbnail">
      <a href="#" @click.prevent="handleToggler">
        <img :src="`${imgChange}`" class="img-fluid" :alt="`${imgChange}`" loading="lazy" />
      </a>
      <div class="mt-2">
  ...
  <!-- <FsLightbox :toggler="toggler" :sources="[imgChange]" /> -->
  <FsLightbox :toggler="toggler" :sources="[require('@/assets/modules/file-manager/images/8.png'), require('@/assets/modules/file-manager/images/7.png'), require('@/assets/modules/file-manager/images/2.png'), require('@/assets/modules/file-manager/images/1.png'), require('@/assets/modules/file-manager/images/6.png'), require('@/assets/modules/file-manager/images/5.png'), require('@/assets/modules/file-manager/images/4.png'), require('@/assets/modules/file-manager/images/8.png')]" />
</template>
<script>
import { ref } from 'vue'
