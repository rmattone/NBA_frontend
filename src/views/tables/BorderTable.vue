      ...
      <div class="card">
        ...
        <div class="card-body px-0">
          <div class="custom-table-effect table-responsive mt-3">
            <data-table :data="BorderTableData.data" :columns="BorderTableData.columns" />
          </div>
        </div>
      </div>
    </div>
      ...
      columns: [
        {
          ...
          render: function (data) {
            return '<div class="d-flex align-items-center"><img class="rounded img-fluid  me-3" src=' + data.img + ' alt=""/><div class="media-support-info"><h6 className="mb-0">' + data.name + '</h6><p className="mb-0">' + data.desc + '</p></div></div>'
          }
        },
        {
          title: 'Contact',
        ...
        },
        {
          ...
          data: 'statustype',
          render: function (data) {
            return '<span class="badge  bg-soft-' + data.bgColor + ' p-2 text-' + data.statusColor + '">' + data.status + '</span>'
          }
        },
        {
          title: 'Action',
          data: 'action',
          render: function (data) {
            return '<div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button"><span class="btn-inner">' + data.actionadd + '</span></a><div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button"><span class="btn-inner">' + data.actionedit + '</span></a><div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button"><span class="btn-inner">' + data.actionremove + '</span></a>'
          }
        }
      ]
    }
