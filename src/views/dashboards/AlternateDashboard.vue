      ...
      <div class="row row-cols-1">
        <div class="d-slider1 overflow-hidden swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
          <Swiper
            ...
            <SwiperSlide class="card card-slide" v-for="(item, index) in swiperItems" :key="index">
              <div class="card-body">
                <div class="progress-widget">
                  <circle-progress :size="item.size" :color="index % 2 ? 'info' : 'primary'">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
            ...
            <div class="card-body">
              <apexchart :height="245" class="d-main" type="area" id="d-main" :options="grossSaleChart.options" :series="grossSaleChart.series" />
            </div>
          </div>
        </div>
          ...
          <div class="card" data-aos="fade-up" data-aos-delay="1000">
            ...
            <div class="card-body">
              <div class="d-flex flex-wrap align-items-center justify-content-between">
                <apexchart :height="230" type="radialBar" class="col-md-8 col-lg-8 myChart" id="myChart1" :options="earningChart.options" :series="earningChart.series" />
        ...
        <div class="col-md-12 col-xl-6">
          <div class="card" data-aos="fade-up" data-aos-delay="1200">
            ...
            <div class="card-body">
              <apexchart :height="230" type="bar" class="d-activity" id="dactivity1" :options="conversionChart.options" :series="conversionChart.series" />
            </div>
          </div>
        </div>
...
import CircleProgress from '@/components/custom/progress/CircleProgress'
export default {
  components: {
    Swiper,
    SwiperSlide,
  ...
  setup() {
    ...
    watch(
      ...
      () => {
        colorsChange()
        grossSaleChart.value = {
          ...grossSaleChart.value,
          options: {
            ...grossSaleChart.value.options,
            colors: colors.value
          }
        }
      },
    ...
    watch(
      ...
      () => {
        ...
        earningChart.value = {
          ...earningChart.value,
          options: {
            ...earningChart.value.options,
            colors: colors.value,
            markers: {
              ...earningChart.value.options.markers,
    ...
    watch(
      ...
      () => {
        ...
        conversionChart.value = {
          ...conversionChart.value,
          options: {
            ...conversionChart.value.options,
            colors: colors.value,
            markers: {
              ...conversionChart.value.options.markers,
              strokeColors: colors.value
            }
          }
        }
