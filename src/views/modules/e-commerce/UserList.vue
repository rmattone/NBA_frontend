      ...
      <div class="card">
        ...
        <div class="card-body px-0">
          <div class="simple-table table-responsive">
            ...
            <DataTable :data="UserListTable.data" :columns="UserListTable.columns" />
          </div>
        </div>
      </div>
    </div>
...
const UserListTable = {
  ...
  columns: [
    ...
    },
    {
      ...
      data: 'statustype',
      render: function (data) {
        return '<span class="badge rounded-pill bg-soft-' + data.bgColor + ' p-2 text-' + data.statusColor + '">' + data.status + '</span>'
      }
    },
    {
      title: 'Action',
