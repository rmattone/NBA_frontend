  ...
  <div id="main" class="header" :style="`background: url(${require('@/assets/images/dashboard/top-image.jpg')}); background-size: cover; background-repeat: no-repeat; height: 100vh;position: relative;`">
    <div class="main-img">
      <b-container>
        ...
        <h1 class="my-4">
          <span>{{ appName }} pro - Design System</span>
        </h1>
        ...
        <b-container fluid>
          ...
          <div class="collapse navbar-collapse" id="navbar-2">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-start">
              ...
              <li class="nav-item">
                <a class="btn btn-success d-flex align-items-center gap-2" aria-current="page" href="https://iqonic.design/item/hope-ui-pro/item-checkout/?coupon_code=DROPBY20" target="_blank">
