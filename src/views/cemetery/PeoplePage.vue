<template>
                ...
                <tr v-for="person in people" :key="person.personId">
                  ...
                  <td>
                    <div class="d-flex justify-content-evenly">
                      <b-button variant="primary " @click="updatePeople(person)">
                        <i class="pencil">
  ...
  <b-modal v-model="personModal" title="Pessoa" centered size="xl" @ok="handleUpdatePerson(person)" @hidden="personModal = false">
    <form>
      <b-row>
        ...
        <b-col md="12" class="form-group">
          ...
          <quill-editor theme="snow" style="height: 200px" v-model:content="person.description" contentType="html" @change="updateDescription" />
        </b-col>
      </b-row>
    </form>
  </b-modal>
